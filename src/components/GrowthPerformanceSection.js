                ...
                <div className="flex flex-col space-y-16 md:space-y-32">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center step-section" data-step="1">
                        ...
                        <div className="order-2 md:order-2">
                            <div className="flex items-center space-x-2 mb-4">
                                <span className="text-xl font-semibold text-[#010C80]">Expert AI Decision Support</span>
                            </div>
                            ...
                            <ul className="space-y-2">
                                <li className="flex items-start space-x-2">
                                    ...
                                    <p className="text-lg text-gray-600">Comprehensive assessment of in-house AI capabilities</p>
                                </li>
                                <li className="flex items-start space-x-2">
                                    <Check className="w-5 h-5 text-green-500 mt-1 flex-shrink-0" />
                                    <p className="text-lg text-gray-600">Evaluation of external AI solutions and their fit</p>
                                </li>
                                <li className="flex items-start space-x-2">
                                    <Check className="w-5 h-5 text-green-500 mt-1 flex-shrink-0" />
                                    <p className="text-lg text-gray-600">Data security and privacy considerations</p>
                                </li>
                                <li className="flex items-start space-x-2">
                                    <Check className="w-5 h-5 text-green-500 mt-1 flex-shrink-0" />
                                    <p className="text-lg text-gray-600">Tailored recommendations for optimal AI strategy</p>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center step-section" data-step="2">
                        <div className="order-2 md:order-1">
                            <div className="flex items-center space-x-2 mb-4">
                                <span className="text-xl font-semibold text-[#010C80]">Smart AI Investments</span>
                            </div>
                            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
                            ...
                            <ul className="space-y-2">
                                <li className="flex items-start space-x-2">
                                    <Check className="w-5 h-5 text-green-500 mt-1 flex-shrink-0" />
                                    <p className="text-lg text-gray-600">Thorough analysis of AI needs and potential impacts</p>
                                </li>
                                <li className="flex items-start space-x-2">
                                    <Check className="w-5 h-5 text-green-500 mt-1 flex-shrink-0" />
                                    <p className="text-lg text-gray-600">Custom AI strategy development</p>
                                </li>
                                <li className="flex items-start space-x-2">
                                    <Check className="w-5 h-5 text-green-500 mt-1 flex-shrink-0" />
                                    <p className="text-lg text-gray-600">ROI projections for AI implementations</p>
                                </li>
                                <li className="flex items-start space-x-2">
                                    <Check className="w-5 h-5 text-green-500 mt-1 flex-shrink-0" />
                                    <p className="text-lg text-gray-600">Guidance on ethical and responsible AI adoption</p>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center step-section" data-step="3">
                        ...
                        <div className="order-2 md:order-2">
                            <div className="flex items-center space-x-2 mb-4">
                                <span className="text-xl font-semibold text-[#010C80]">Your strategic AI partner</span>
                            </div>
                            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
                            ...
                            <ul className="space-y-2">
                                <li className="flex items-start space-x-2">
                                    <Check className="w-5 h-5 text-green-500 mt-1 flex-shrink-0" />
                                    <p className="text-lg text-gray-600">Vendor-neutral assessment of AI solutions and providers</p>
                                </li>
                                <li className="flex items-start space-x-2">
                                    <Check className="w-5 h-5 text-green-500 mt-1 flex-shrink-0" />
                                    <p className="text-lg text-gray-600">Technical due diligence on proposed AI implementations</p>
                                </li>
                                <li className="flex items-start space-x-2">
                                    <Check className="w-5 h-5 text-green-500 mt-1 flex-shrink-0" />
                                    <p className="text-lg text-gray-600">Negotiation support for optimal terms and deliverables</p>
                                </li>
                                <li className="flex items-start space-x-2">
                                    <Check className="w-5 h-5 text-green-500 mt-1 flex-shrink-0" />
                                    <p className="text-lg text-gray-600">Ongoing project oversight and quality assurance</p>
                                </li>
                            </ul>
                        </div>
                    </div>
